    ...
    >
      ...
      <div className="relative z-10 mb-4 flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-300">Peak UV around {peakPoint.time}</p>
        </div>
      ...
      <div className="relative z-10 mb-3 grid grid-cols-1 gap-2 sm:grid-cols-3">
        <div className="rounded-xl border border-slate-200 bg-white/90 p-2.5 dark:border-slate-700 dark:bg-slate-800/80">
          ...
          <p className="mt-0.5 text-sm font-bold text-slate-900 dark:text-slate-50">{peakPoint.time}</p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white/90 p-2.5 dark:border-slate-700 dark:bg-slate-800/80">
          <p className="text-[11px] text-slate-500 dark:text-slate-400">Current UV</p>
          <p className="mt-0.5 text-sm font-bold text-slate-900 dark:text-slate-50">{currentPoint ? currentPoint.uv.toFixed(1) : "--"}</p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white/90 p-2.5 dark:border-slate-700 dark:bg-slate-800/80">
